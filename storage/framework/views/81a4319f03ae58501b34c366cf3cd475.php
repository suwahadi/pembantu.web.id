    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                    <a href="/login" class="text-gray-600 hover:text-gray-900 transition">
                        <?php echo $__env->make('svgs.icon-user', ['class' => 'w-5 h-5'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </a>
            ...
            <button class="md:hidden">
                <?php echo $__env->make('svgs.icon-menu', ['class' => 'w-6 h-6'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </button>
        </div>
    </div>
</nav>
<?php /**PATH C:\laragon\www\pembantu.web.id\resources\views/livewire/shared/navbar.blade.php ENDPATH**/ ?>