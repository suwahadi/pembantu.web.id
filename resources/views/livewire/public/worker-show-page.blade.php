            ...
            <div class="sticky top-24">
                <div class="overflow-hidden rounded-3xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 shadow-sm">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-8">
                            <button class="w-full rounded-2xl bg-blue-600 px-6 py-4 text-sm font-bold text-white shadow-xl shadow-blue-500/20 hover:bg-blue-700 transition-all active:scale-95">
                                Pesat Sekarang
                            </button>
