<div class="max-w-2xl mx-auto space-y-4">
  ...
  <x-card title="Rekening Bank Saya" subtitle="Kelola rekening untuk menerima pembayaran">
    @if(empty($items->toArray()))
      <div class="text-sm text-gray-600">Anda belum menambahkan rekening bank.</div>
    @else
      <div class="space-y-2">
  ...
  <x-card title="Tambah Rekening Baru">
    ...
    <div class="mt-3 p-3 bg-yellow-50 border border-yellow-200 text-yellow-800 rounded-lg text-xs flex items-start gap-2">
      ...
      <span>Rekening baru akan melalui verifikasi oleh admin sebelum dapat digunakan sebagai rekening utama untuk menerima pembayaran.</span>
    </div>
  </x-card>
</div>
