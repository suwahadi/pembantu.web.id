<header class="sticky top-0 z-40 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-xl font-semibold text-gray-800 dark:text-white/90">{{ $title ?? 'Dashboard' }}</h1>
        </div>
                    ...
                    <div class="max-h-96 overflow-y-auto">
                        <div class="p-4 space-y-3">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <p class="text-sm text-gray-900 dark:text-white">New agency application</p>
