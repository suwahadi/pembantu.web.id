...
<div>
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.agencies.create') }}" class="px-4 py-2 bg-success-500 text-white rounded-lg hover:bg-success-600 transition-colors flex items-center gap-2">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        <div class="text-center py-8">
            ...
            <p class="text-gray-500 dark:text-gray-400">Halaman agencies dalam development</p>
        </div>
    </div>
</div>
@endsection
